...
**Current app release:** MultiCamApp **v2.0.5** (build **338**, Stable), 2026-07-10 — see FREEZE LIFTED note above; post-freeze exceptions below remain the historical record of changes made while still frozen  
