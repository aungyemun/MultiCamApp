...
MultiCamApp may be used for non-commercial academic research, scientific work, education, laboratory experiments, reproducibility studies, and evaluation purposes.
...
MultiCamApp includes bundled third-party components, including OpenCV, FFmpeg/ffprobe, and the .NET runtime. See `THIRD_PARTY_NOTICES.md` for license and attribution details.
