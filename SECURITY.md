...
- **Bundled third-party components** — ffprobe, ffmpeg, OpenCV, and the .NET runtime are bundled. See below.
...
| ffmpeg.exe | GPL v3 | Standalone exe; powers opt-in Deep Verify per-frame MD5 check; not linked into MultiCamApp.exe |
